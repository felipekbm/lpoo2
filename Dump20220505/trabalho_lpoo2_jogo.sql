...
CREATE TABLE `jogo` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK_Selecao1_Jogo` (`selecao_1`),
  KEY `FK_Selecao2_Jogo` (`selecao_2`),
...
INSERT INTO `jogo` VALUES (1,1,2,'2022-01-01','1X0','MARACANA'),(4,3,2,'3922-03-02','4 X 0','ESTÁDIO AZUL'),(5,3,1,'3922-03-02','1 X 1','ESTADIO ROSA');
